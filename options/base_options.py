...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--tasks', type=list, default=['facades', 'mini'])
        ...
        parser.add_argument('--loadSize', type=int, default=143, help='scale images to this size')
        ...
        # TODO: set ngf=64 ndf=64 when training on multi GPU
        ...
        parser.add_argument('--serial_batches', type=dict, default={'facades': True, 'mini': False}, help='if true, takes images in order to make batches, otherwise takes them randomly')
